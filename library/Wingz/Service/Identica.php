...
/**
 * On March 11, 2011 Twitter decided to change it's rules on how developers
 * could interact with their API, resulting a major shift towards alternatives
 * like identi.ca of status.net
 * 
 * @package		Wingz_Service
 * @link		http://status.net/wiki/Twitter-compatible_API
 * @see			TC article: {@link http://techcrunch.com/2011/03/11/twitter-ecosystem-guidelines/}
 */
/**
...
class Wingz_Service_Identica extends Zend_Rest_Client
{
    /**
     ...
     * @var API base
     */
    const API_BASE_URI = 'http://identi.ca/api';
     ...
     * @param  string $type
     * @return Wingz_Service_Identica
     * @throws Wingz_Service_Identica_Exception If method not in method types list
     */
    public function __get($type)
    {
        if (!in_array($type, $this->_methodTypes)) {
            include_once 'Wingz/Service/Identica/Exception.php';
     ...
     * @param  array $params
     * @return mixed
     * @throws Wingz_Service_Identica_Exception if unable to find method
     */
    ...
    protected function _init()
    {
        if (!$this->isAuthorised() && $this->getUsername() !== null) {
            ...
            throw new Wingz_Service_Identica_Exception(
                ...
                . 'Wingz_Service_Identica with an OAuth Access Token or use '
     ...
     * @return Zend_Rest_Client_Result
     * @throws Zend_Http_Client_Exception if HTTP request fails or times out
     * @throws Wingz_Service_Identica_Exception if message is too short or too long
     */
    ...
    /**
     * Validate a screen name using Identica rules
     *
     * @param string $name
